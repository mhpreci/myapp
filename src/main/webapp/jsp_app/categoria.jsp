<%-- 
    Document   : categoria
    Created on : 28/07/2019, 09:48:35 PM
    Author     : mhpre
--%>
        ...
        <div class="page-container">
            ...
            <div class="sidebar-menu">
                <div class="sidebar-header">
                    <div class="logo">
                        <a href="index.jsp"><img src="<%out.print(getServletContext().getContextPath());%>/assets/images/icon/logo.png" alt="logo"></a>
                    </div>
                    <br>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-12">
                                            <select class="form-control form-control-sm" id="sizePageCategoria" name="sizePageCategoria">
